        ...
        <div class="wrapper">
            ...
            <main class="page">
                <div class="container">
                    ...
                    <h2 class="under__title">Панель администратора</h2>
                    ...
                    <div class="three-block">
                        <div class="three-block__row">
                            <div class="three-block__column">
                                ...
                                <div class="three-block__item__logo">
                                    <div class="three-block__image">
                                        <a href="admin_base.php"><img class="three-block__img" src="/img/database.png" alt="Картинка"></a>
                                    </div>
                                </div>
                                <div class="three-block__item__logo">
                                    <div class="three-block__image">
                                        <a href="admin_orders.php"><img class="three-block__img" src="/img/orders.png" alt="Картинка"></a>
                                    </div>
                                </div>
                            </div>
                        </div>

        ...
        <div class="wrapper">
                            ...
                            <ul class="menu__list">
                                ...
                                <li><div class="dropdown"><a href="#" class="menu__auth active">Личный кабинет</a>
                                        <div class="dropdown__content">
                                            ...
                                            <a href="worker_base.php">База данных</a>
                                        </div>   
                                    </div> 
                                </li>
            ...
            <main class="page">
                <div class="container">
                    ...
                    <h2 class="under__title">Панель сотрудника</h2>
                    ...
                    <div class="three-block">
                        <div class="three-block__row">
                            <div class="three-block__column">
                                ...
                                <div class="three-block__item__logo">
                                    <div class="three-block__image">
                                        <a href="worker_base.php"><img class="three-block__img" src="/img/database.png" alt="Картинка"></a>
                                    </div>
                                </div>
                            </div>
                        </div>

...
$result = mysqli_query($connect, "SELECT * FROM `News` ORDER BY `News_Date` DESC");
session_start();
?>
        ...
        <div class="wrapper">
                    ...
                    <div class="header__row">
                        ...
                        <nav class="menu__body">
                            <ul class="menu__list">
                                ...
                                <li><a href="#" class="menu__link active">Новости</a></li>
            ...
            <main class="page">
                <div class="container">
                    ...
                    <h2 class="under__title">Наши новости</h2>
                                ...
                                <?php while ($news = mysqli_fetch_assoc($result)) { ?>
                                    <div class="three-block__item">
                                        <div class="three-block__image">
                                            ...
                                            base64_encode($news['News_Image']) . '"alt="Картинка">';?>
                                        </div>
                                        <form action="vendor/add_to_cart.php" method="post">
                                                <input type="hidden" name="news_id" value="<?php echo $news['News_ID']; ?>">
                                            <div class="three-block__text long">
                                                <?php echo '<a type="submit" class="custom-title">'. $news['News_Title'] . '</a>';?>
                                            </div>
                                        </form>
                                        <div class="three-block__text__date">
                                        <?php
                                        echo $news['News_Date'];
                                        ?>
                                        </div>

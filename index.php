            ...
            <main class="page">
                <div class="container">
                    ...
                    <div class="slideshow__container">
                        ...
                        <a class="prev" onclick="plusSlides(-1)"><img src="img/arrow.png"></a>
                        <a class="next" onclick="plusSlides(1)"><img src="img/arrow.png"></a>
                    </div>
                    <script src="js/slider.js"></script>

                    <h1 class="main__title">Брендинговое агентство Agency</h1>
                    <h2 class="under__title__index">Создаем убедительные бренды</h2>
                    <div class="rubric__title">AGENCY&nbsp;– брендинговое агентство с&nbsp;многолетним опытом. 
                    Помогаем найти ответы на&nbsp;вопросы брендинга</div>
                            ...
                            <div class="three-block__column">
                                <div class="three-block__item__logo">
                                    <div class="three-block__image">
                                        <img class="three-block__img" src="img/log1.png" alt="Картинка">
                                    </div>
                                </div>
                                <div class="three-block__item__logo">
                                    <div class="three-block__image">
                                        <img class="three-block__img" src="img/log2.png" alt="Картинка">
                                    </div>
                                </div>
                                <div class="three-block__item__logo">
                                    <div class="three-block__image">
                                        <img class="three-block__img" src="img/log3.png" alt="Картинка">
                                    </div>
                                </div>
                            </div>
                        </div>

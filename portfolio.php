...
<html lang="ru">
    ...
    <body>
        <div class="wrapper">
                    ...
                    <div class="header__row">
                        ...
                        <nav class="menu__body">
                            <ul class="menu__list">
                                ...
                                <li><div class="dropdown"><a href="#" class="menu__link  active">Портфолио</a>
                                        <div class="dropdown__content">
                                            <a href="#port1">Наружная и интерьерная реклама</a>
                                            <a href="#port2">Вентилируемые фасады</a>
                                        </div>   
                                    </div> 
                                </li>
            ...
            <main class="page">
                <div class="container">
                    <h2 id="port1" class="under__title">Наружная и интерьерная реклама</h2>

                    <div class="three-block">
                        <div class="three-block__row">
                            <div class="three-block__column">

                                <?php $result = mysqli_query($connect, "SELECT * FROM `Portfolio` WHERE `Portfolio_Category` = 'Наружная и интерьерная реклама'");
                                while ($port = mysqli_fetch_assoc($result)) { ?>
                                    <div class="three-block__item__portfolio">
                                        <div class="three-block__image">
                                            <?php echo '<img class="three-block__img"' . 'src="data:image/jpg;base64,'. 
                                            base64_encode($port['Portfolio_Image']) . '"alt="Картинка">';?>
                                        </div>
                                    </div>
                                <?php } ?>
                    ...
                    <h2 id="port2" class="under__title">Вентилируемые фасады</h2>

                    <div class="three-block">
                        <div class="three-block__row">
                            <div class="three-block__column">
                            <?php $result = mysqli_query($connect, "SELECT * FROM `Portfolio` WHERE `Portfolio_Category` = 'Вентилируемые фасады'");
                            while ($port = mysqli_fetch_assoc($result)) { ?>
                                    <div class="three-block__item__portfolio">
                                        <div class="three-block__image">
                                            <?php echo '<img class="three-block__img"' . 'src="data:image/jpg;base64,'. 
